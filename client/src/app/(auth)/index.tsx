import {TouchableOpacity, View, Text, Module, KeyboardAvoidingView, Platform, ScrollView, ActivityIndicator } from 'react-native'
        ...
        keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.form}>
            ...
            <View style={styles.toggleRow}>
              <Text style={styles.toggleText}>Did not receive a code ?
        ...
        keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.form}>
            {mode === "register" && (
              ...
              <View style={styles.field}>
                <Text style={styles.fieldLabel}>Username Handle
                </Text>
                <View style={styles.handleRow} >
                  ...
                  <TextInput
                   ...
                   value={handle}
                   onChangeText={(v)=>setHandle(v.toLocaleLowerCase().replace(/\s/g,""))}
